...
# --- 1. SETUP & DATA ---
# Updated the Page Title to your new name
...
# --- 5. CHAT LOGIC ---
# Display the new bot name as the Header
...
if user_input := st.chat_input("Ex: 'EY eco dec 2026'"):
    ...
    with st.chat_message("assistant"):
        # Fix for ValueError: Use 'is None' to check for missing rows
        ...
        if target_row is not None:
            ...
            # --- 3. THE FINAL SUCCESS ---
                ...
                final_reply = f"✅ Deal Found! **{airline_name}** {found_cabin.upper()} is **{price}** (Valid: {val_text})."
                final_table = target_row
                st.session_state.pending_row = None 
